...
version 3.2: 01.01.18 user photos
version 4.0: 03.01.18 adding account SIDs
version 4.1: 12/6/2018
...
"
        ...
        Write-Output "Great, the scan was started - version 4.1.`nIt could take a while, (5-60+ mins) depends on the size of the network`n"
